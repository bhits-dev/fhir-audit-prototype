...
public class FhirServiceConfig {
    ...
    public FhirContext fhirContext() {
        ...
        fhirContext.getRestfulClientFactory().setSocketTimeout(Integer.parseInt(fhirProperties.getFhir().getPublish().getClientSocketTimeoutInMs()));
        return fhirContext;
    }
    ...
    public Map<Class<? extends Resource>, IGenericClient> fhirClients() {
        ...
        fhirClients.put(Resource.class, fhirContext().newRestfulGenericClient(fhirProperties.getFhir().getPublish().getServerUrl().getResource()));
        return fhirClients;
    }
